...
public class AdminController : ControllerBase
{
    ...
    public AdminController(ApartmentAdsDbContext context)
    {
    ...
    [HttpGet("{adminId}")]
    public async Task<ActionResult<UserDto>> Get(int adminId)
    {
        var firstUser = await _context.Admins.FirstOrDefaultAsync(u => u.Id == adminId);
    ...
    public async Task<ActionResult<UserDto>> Create(CreateUserDto createUserDto)
    {
        ...
        var newUser = new Admin(createUserDto.Login, createUserDto.Email, createUserDto.Password, createUserDto.Name,
            DateTime.Now);
    ...
    [HttpPut("{adminId}")]
    public async Task<ActionResult<UserDto>> Update(int adminId, UpdateUserDto updateUserDto)
    {
    ...
    public async Task<ActionResult> Delete(int adminId)
    {
        ...
        _context.Admins.Remove(firstUser);
        await _context.SaveChangesAsync();
